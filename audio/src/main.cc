...
int main() {
    try {
        // 初始化推理引擎
        std::string asr_onnx = "models/model.onnx";
        std::string tokens = "models/tokens.txt";
        std::string vad_onnx = "/home/nanxun/Documents/silero_vad_cpp/model/silero_vad.onnx";

        std::string wav = "/home/nanxun/Documents/duix.ai.core/audio/test.wav";
